...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2014 at 04:25 PM
...
INSERT INTO `admins` (`id`, `name`, `email`, `contact_number`, `photos`, `updated_at`, `created_at`) VALUES
(1, 'admin', 'a@a.com', '2353535', NULL, NULL, NULL);
...
(2, 'ii', 'ii', '', 'Expert Php', 'Individual', '30', 1, '2014-10-15', '2014-08-28', 'i2@i2.com', NULL, NULL, 1, 1, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', NULL, NULL, '1409737495_(2)_Facebook_-_2014-04-17_09.23.42.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1, 1, 1),
...
CREATE TABLE IF NOT EXISTS `job_offers` (
  ...
  `description` text,
  `job_offer_status` enum('Pending','Approved','Canceled','Accepted','Paused','Declined') DEFAULT NULL COMMENT 'Admin get Pending Job offer listAdmin can Approve or CancelFreelancer can Accept or Decline',
...
(41, 2, 2, 43, 'Test Job offer title', 'Test Job offer title', 'Accepted', 'Job offer has been accepted by admin', '690', '23', '2014-10-15', '2014-10-15', NULL),
(42, 2, 2, 44, 'Expert Php developer needed', 'Expert Php developer needed', 'Declined', 'Job offer has been declined by admin', '360', '12', '2014-10-15', '2014-10-15', NULL),
(43, 4, 2, 44, 'Expert Php developer needed', 'Expert Php developer needed', 'Canceled', 'Job offer has been canceled by admin', '360', '12', '2014-10-15', '2014-10-15', NULL),
(44, 6, 2, 45, 'Expert Python developer needed', 'When this css rule is loaded by the browser, all html elements (including their children) that are tagged with the ngCloak directive are hidden. When Angular encounters this directive during the compilation of the template it deletes the ngCloak element attribute, making the compiled element visible.', 'Approved', 'Job offer has been approved by admin', '750', '25', '2014-10-15', '2014-10-15', NULL),
(48, 2, 2, 45, 'Expert Python developer needed', 'When this css rule is loaded by the browser, all html elements (including their children) that are tagged with the ngCloak directive are hidden. When Angular encounters this directive during the compilation of the template it deletes the ngCloak element attribute, making the compiled element visible.', 'Accepted', 'Your request has been accepted by client', '300', '10', '2014-10-15', '2014-10-15', NULL);
...
(43, 2, 2, '2014-10-15', '2014-10-15', 'Test Job offer title', 'Test Job offer title', '{}', 690, 23, 'Pending', '30', NULL),
(44, 2, 2, '2014-10-15', '2014-10-15', 'Expert Php developer needed', 'Expert Php developer needed', '{}', 720, 23, 'Pending', '30', NULL),
(45, 2, 2, '2014-10-15', '2014-10-15', 'Expert Python developer needed', 'When this css rule is loaded by the browser, all html elements (including their children) that are tagged with the ngCloak directive are hidden. When Angular encounters this directive during the compilation of the template it deletes the ngCloak element attribute, making the compiled element visible.', '{}', 1050, 35, 'Pending', '30', NULL);
...
CREATE TABLE IF NOT EXISTS `job_requests` (
  ...
  `freelancer_id` int(11) DEFAULT NULL,
  `request_status` enum('Accepted','Requested','Declined','Approved','Canceled') DEFAULT NULL,
  `created_at` date DEFAULT NULL,
  `updated_at` date DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(3, 45, 2, 'Accepted', '2014-10-15', '2014-10-15');
...
(41, 41, 2, 'Client', 'Pending', 'New job has been created', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(42, 42, 2, 'Client', 'Pending', 'New job has been created', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(43, 43, 2, 'Client', 'Pending', 'New job has been created', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(44, 41, 1, 'Admin', 'Approved', 'Job offer has been approved by admin', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(45, 42, 1, 'Admin', 'Approved', 'Job offer has been approved by admin', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(47, 43, 1, 'Admin', 'Canceled', 'Job offer has been canceled by admin', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(48, 41, 2, 'Freelancer', 'Accepted', 'Job offer has been accepted by admin', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(49, 42, 2, 'Freelancer', 'Declined', 'Job offer has been declined by admin', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(50, 44, 2, 'Client', 'Pending', 'New job has been created', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(51, 44, 1, 'Admin', 'Approved', 'Job offer has been approved by admin', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00'),
(55, 48, 2, 'Client', 'Accepted', 'Your request has been accepted by client', '2014-10-15', '2014-10-15', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `notification_type` enum('Job Invitation','Team Invitation','Job Request','New Job Offer') NOT NULL,
...
(18, 1, 'New Job Offer', '<strong><a target="_blank" href="http://client.marketplace/view/client/QTn1TP">tanvir anowar</a> has been invited to\r\n                        <a target="_blank" href="http://client.marketplace/view/freelancer/QTn1TP">ii ii</a>.\r\n                        </strong><br/>Please click following link to read job details and approve job invitation:<br/>\r\n                    <a target="_blank" href="http://client.marketplace/view/job/gTE1UP">Test Job offer title</a>', 1, 'Admin', '2014-10-15', '2014-10-15', 'admin/job-invitation', 'New Job Offer', 'gTEVUP'),
(19, 1, 'New Job Offer', '<strong><a target="_blank" href="http://client.marketplace/view/client/QTn1TP">tanvir anowar</a> has been invited to\r\n                        <a target="_blank" href="http://client.marketplace/view/freelancer/QTn1TP">ii ii</a>.\r\n                        </strong><br/>Please click following link to read job details and approve job invitation:<br/>\r\n                    <a target="_blank" href="http://client.marketplace/view/job/gTEFVP">Expert Php developer needed</a>', 1, 'Admin', '2014-10-15', '2014-10-15', 'admin/job-invitation', 'New Job Offer', 'gTElUP'),
(20, 1, 'New Job Offer', '<strong><a target="_blank" href="http://client.marketplace/view/client/QTn1TP">tanvir anowar</a> has been invited to\r\n                        <a target="_blank" href="http://client.marketplace/view/freelancer/QTn1TP">lkjlkj lkjlkj</a>.\r\n                        </strong><br/>Please click following link to read job details and approve job invitation:<br/>\r\n                    <a target="_blank" href="http://client.marketplace/view/job/gTEFVP">Expert Php developer needed</a>', 1, 'Admin', '2014-10-15', '2014-10-15', 'admin/job-invitation', 'New Job Offer', 'gTE1UP'),
(21, 2, 'Job Invitation', '<strong><a target="_blank" href="http://freelancer.marketplace/view/client/QTn1TP">tanvir anowar</a>\r\n                has been invited to you.</strong><br/>Please click following link to read job details and accept job invitation:<br/>\r\n                <a target="_blank" href="http://freelancer.marketplace/view/job/gTE1UP">Test Job offer title</a>', 1, 'Freelancer', '2014-10-15', '2014-10-15', 'job-invitation', 'Job Invitation', 'gTEVUP'),
(22, 2, 'Job Accepted', '<strong>Your job offer has been approved.</strong><br/>Please click following link to see job details:<br/>\r\n                <a target="_blank" href="http://client.marketplace/jobPost/view/gTE1UP">Test Job offer title</a>', 1, 'Client', '2014-10-15', '2014-10-15', 'notification/view', '', 'gTEVUP'),
(23, 2, 'Job Invitation', '<strong><a target="_blank" href="http://freelancer.marketplace/view/client/QTn1TP">tanvir anowar</a>\r\n                has been invited to you.</strong><br/>Please click following link to read job details and accept job invitation:<br/>\r\n                <a target="_blank" href="http://freelancer.marketplace/view/job/gTEFVP">Expert Php developer needed</a>', 1, 'Freelancer', '2014-10-15', '2014-10-15', 'job-invitation', 'Job Invitation', 'gTElUP'),
(24, 2, 'Job Accepted', '<strong>Your job offer has been approved.</strong><br/>Please click following link to see job details:<br/>\r\n                <a target="_blank" href="http://client.marketplace/jobPost/view/gTEFVP">Expert Php developer needed</a>', 1, 'Client', '2014-10-15', '2014-10-15', 'notification/view', '', 'gTElUP'),
(25, 2, 'Job Accepted', '<strong>Your job offer has been accepted by <a target="_blank" href="http://client.marketplace/view/freelancer/QTn1TP">ii ii</a>\r\n                    .</strong><br/>Please click following link to see job details:<br/>\r\n                <a target="_blank" href="http://client.marketplace/jobPost/view/gTE1UP">Test Job offer title</a><br/><br/>\r\n                ', 1, 'Client', '2014-10-15', '2014-10-15', 'notification/view', '', 'gTEVUP'),
(26, 2, 'Job Declined', '<strong>Your job offer has been declined by <a target="_blank" href="http://client.marketplace/view/freelancer/QTn1TP">ii ii</a>.</strong><br/>Please click following link to see job details:<br/>\r\n                <a target="_blank" href="http://client.marketplace/jobPost/view/gTEFVP">Expert Php developer needed</a><br/><br/>\r\n                If you need any query then please contact with support team.', 1, 'Client', '2014-10-15', '2014-10-15', 'notification/view', '', 'gTElUP'),
(27, 1, 'New Job Offer', '<strong><a target="_blank" href="http://client.marketplace/view/client/QTn1TP">tanvir anowar</a> has been invited to\r\n                        <a target="_blank" href="http://client.marketplace/view/freelancer/gTn1TP">Tanvir Anowar</a>.\r\n                        </strong><br/>Please click following link to read job details and approve job invitation:<br/>\r\n                    <a target="_blank" href="http://client.marketplace/view/job/gTEVVP">Expert Python developer needed</a>', 1, 'Admin', '2014-10-15', '2014-10-15', 'admin/job-invitation', 'New Job Offer', 'gTEFVP'),
(28, 1, 'Freelancer Job Request', 'You get job request from freelancer <b>iiii ii</b> <br/>Visit job post link <a target="_blank" href="http://freelancer.marketplace/view/job/QTn1TP/gTEVVP">http://freelancer.marketplace/view/job/QTn1TP/gTEVVP</a>', 1, 'Admin', '2014-10-15', '2014-10-15', 'admin/job-request', 'Job Request', 'QT31TP'),
(29, 6, 'Job Invitation', '<strong><a target="_blank" href="http://freelancer.marketplace/view/client/QTn1TP">tanvir anowar</a>\r\n                has been invited to you.</strong><br/>Please click following link to read job details and accept job invitation:<br/>\r\n                <a target="_blank" href="http://freelancer.marketplace/view/job/gTEVVP">Expert Python developer needed</a>', 0, 'Freelancer', '2014-10-15', '2014-10-15', 'job-invitation', 'Job Invitation', 'gTEFVP'),
(30, 2, 'Job Approved', '<strong>Your job offer has been approved.</strong><br/>Please click following link to see job details:<br/>\r\n                <a target="_blank" href="http://client.marketplace/jobPost/view/gTEVVP">Expert Python developer needed</a>', 1, 'Client', '2014-10-15', '2014-10-15', 'notification/view', '', 'gTEFVP'),
(31, 2, 'Job Request From iiii ii', 'Hello, you have a job request review <br/><strong>iiii ii Want to work for this job <a href="">Job</a></strong>', 1, 'Client', '2014-10-15', '2014-10-15', 'client/job-request', 'Job Request', 'QT31TP'),
(34, 2, 'Job Accepted', '<strong>Your job request has been accepted by <a target="_blank" href="http://freelancer.marketplace/view/client/QTn1TP">tanvir anowar</a>\r\n                    .</strong><br/>Please click following link to see job details:<br/>\r\n                <a target="_blank" href="http://freelancer.marketplace/view/job/gTEVVP">Expert Python developer needed</a><br/><br/>\r\n                ', 0, 'Freelancer', '2014-10-15', '2014-10-15', 'job-notification', '', 'gTEdWP');
...
(148, 43, 'JobPost', 1, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(149, 43, 'JobPost', 9, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(150, 43, 'JobPost', 2, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(151, 44, 'JobPost', 1, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(152, 44, 'JobPost', 9, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(153, 44, 'JobPost', 2, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(154, 44, 'JobPost', 7, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(155, 44, 'JobPost', 4, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(156, 44, 'JobPost', 6, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(157, 45, 'JobPost', 1, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(158, 45, 'JobPost', 2, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL),
(159, 45, 'JobPost', 4, '2014-10-15', '2014-10-15', NULL, 1, 0, '', '', '', NULL, '', 0, NULL, NULL, NULL);
...
(25, 0, '127.0.0.1', 0, 0, 0, NULL, NULL, NULL);
...
(0, 'a@a.com', '$2y$10$S3P8DPQaTUqYzOZXY4DB3OUSEOYWHL3./yhEPOi.wmh3t4YsoW.WW', NULL, 1, NULL, NULL, '2014-10-15 06:28:57', '$2y$10$bA0LRq1PH7tlvEddb/yqW.MsxRRYF7tIxx4xQPe16zLdDVKzWd3Ku', NULL, 'Admin', 'Admin', '2014-08-23 01:15:23', '2014-10-15 06:28:57', 1, 'Admin', NULL),
(64, 'c@c.com', '$2y$10$9n2ZBqBbsFBtm8xC1/cabObiSYoFXHd/fCLIXdeqQRgyrDiRCsV1u', NULL, 1, NULL, '2014-09-06 22:48:45', '2014-10-15 06:29:41', '$2y$10$BKFS7/RDGoxF0iUt78v1We5cL/MdJS2kB3H85VHn9lRoQ0demlEHC', NULL, 'Client', 'Client', '2014-09-06 22:48:21', '2014-10-15 06:29:41', 2, 'Client', NULL),
...
(66, 'i@i.com', '$2y$10$uMPDUoEZyNzTDWZORxYmVec2I74XjvyTlVhJhSEBf5sk6BA9Yg61G', NULL, 1, NULL, '2014-09-06 22:55:42', '2014-10-15 03:41:16', '$2y$10$ChBxfwpBM5FaEczsSoXuuOR32PoHAlNmOY9z1VOz2G7vAmzeZOkdu', NULL, 'First Namesdf', 'Last Namesdf', '2014-09-06 22:54:43', '2014-10-15 03:41:16', 5, 'Freelancer', 0),
(67, 'i2@i2.com', '$2y$10$uMPDUoEZyNzTDWZORxYmVec2I74XjvyTlVhJhSEBf5sk6BA9Yg61G', NULL, 1, NULL, '2014-09-06 22:55:42', '2014-10-15 06:25:04', '$2y$10$R8BpPOZuE2otxvAWNnSaLurnepnNZQ5a35Qf.xGUuum9kJV2HNMTK', NULL, 'First Namesdf', 'Last Namesdf', '2014-09-06 22:54:43', '2014-10-15 06:25:04', 2, 'Freelancer', 0),
