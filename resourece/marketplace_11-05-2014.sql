...
CREATE TABLE `discussion_comments` (
  ...
  CONSTRAINT `discussion_comments_ibfk_1` FOREIGN KEY (`discussion_id`) REFERENCES `discussions` (`discussion_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('0', 'superadmin@mail.com', '$2y$10$S3P8DPQaTUqYzOZXY4DB3OUSEOYWHL3./yhEPOi.wmh3t4YsoW.WW', null, '1', null, null, '2014-10-30 07:57:58', '$2y$10$3RN2p/R6l2V3vUenk4kGuObdqitTRf7v63Phc7xbJ2MakcTg/UcIe', null, 'Admin', 'Admin', '2014-08-23 07:15:23', '2014-10-30 07:57:58', '1', 'Admin', null);
