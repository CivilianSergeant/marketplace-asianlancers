...
CREATE TABLE `payments` (
  ...
  CONSTRAINT `fk_payment_jobphase_id` FOREIGN KEY (`job_offer_id`) REFERENCES `job_phases` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `users` VALUES ('64', 'c@c.com', '$2y$10$9n2ZBqBbsFBtm8xC1/cabObiSYoFXHd/fCLIXdeqQRgyrDiRCsV1u', null, '1', null, '2014-09-06 15:48:45', '2014-10-29 17:20:49', '$2y$10$oiNQnJMQSTah1QGkJrjrfOFos9pKaqKWCngTAzcV3uykkT5cWppOK', null, 'Client', 'Client', '2014-09-06 15:48:21', '2014-10-29 17:20:49', '2', 'Client', null);
