...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2014 at 11:08 AM
...
(11, 2, 2, 27, 'Test Job offer title', 'The database query builder provides a convenient, fluent interface to creating and running database queries. It can be used to perform most database operations in your application, and works on all supported database systems.', 'Pending', '', '150', '5', '2014-10-02', '2014-10-02', NULL),
(12, 4, 2, 27, 'Test Job offer title', 'The database query builder provides a convenient, fluent interface to creating and running database queries. It can be used to perform most database operations in your application, and works on all supported database systems.', 'Pending', '', '120', '4', '2014-10-02', '2014-10-02', NULL),
(13, 6, 2, 27, 'Test Job offer title', 'The database query builder provides a convenient, fluent interface to creating and running database queries. It can be used to perform most database operations in your application, and works on all supported database systems.', 'Pending', '', '210', '7', '2014-10-02', '2014-10-02', NULL),
(14, 7, 2, 27, 'Test Job offer title', 'The database query builder provides a convenient, fluent interface to creating and running database queries. It can be used to perform most database operations in your application, and works on all supported database systems.', 'Pending', '', '120', '4', '2014-10-02', '2014-10-02', NULL),
(15, 7, 2, 28, 'Test Job offer title', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book', 'Pending', '', '600', '20', '2014-10-12', '2014-10-12', NULL),
(16, 6, 2, 28, 'Test Job offer title', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 'Pending', '', '900', '30', '2014-10-12', '2014-10-12', NULL);
...
(2, 'a@a.com', '$2y$10$S3P8DPQaTUqYzOZXY4DB3OUSEOYWHL3./yhEPOi.wmh3t4YsoW.WW', NULL, 1, NULL, NULL, '2014-10-02 01:38:54', '$2y$10$kK/wUcqGdsaloFdN2CKPLeZ.CS.BMKJp6gqM8jb7K3aC2SrQ/RO/2', NULL, 'Admin', 'Admin', '2014-08-23 01:15:23', '2014-10-02 01:38:54', NULL, 'Admin', NULL),
(64, 'c@c.com', '$2y$10$9n2ZBqBbsFBtm8xC1/cabObiSYoFXHd/fCLIXdeqQRgyrDiRCsV1u', NULL, 1, NULL, '2014-09-06 22:48:45', '2014-10-12 00:57:11', '$2y$10$6LWKdKkv0kvjAo3KpRqae.JZHHtX6VAOFoT.xqNHV8voKoj1EB5Gi', NULL, 'Client', 'Client', '2014-09-06 22:48:21', '2014-10-12 00:57:11', 2, 'Client', NULL),
