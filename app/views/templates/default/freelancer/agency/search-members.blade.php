            ...
            <div class="pi-tabs-content pi-tabs-content-transparent">
                ...
                <div ng-app="memberApp" ng-controller="memberController" ng-cloak>
                    ...
                    <div class="pi-row pi-no-margin pi-margin-bottom-20 col-lg-12 form-horizontal breadcrumb">
                        ...
                        <div class="form-group">
                            <div class="col-lg-9">
                                <button type="submit" class="btn pi-btn-base">{{Translate::get("Search",$lang)}}</button>
                            </div>
                        </div>
                    </div>

                    </form>
                    <form ng-if="freelancers.length" id="sentRequestFrm" ng-submit="sentRequest()">
                    ...
                    <div class="freelancers_lists" ng-repeat="freelancer in freelancers">
                        ...
                        <input type="submit" class="btn pi-btn-base" value="Send Request"/>
                    </form>
