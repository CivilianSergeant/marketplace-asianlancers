                ...
                <div class="col-lg-12">
                    ...
                    <form class="form-horizontal" action="{{url('widget/save-widget')}}" method="POST">
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <input type="text" maxlength="20" name="title" class="form-control" value="{{$widget->widget_name}}"/>
                            ...
                            <div class="col-lg-4">
                                <select name="type" class="form-control">
                                    @foreach($types as $type)
                                        @if($widget->type == $type)
                                            <option selected="selected" value="{{$type}}">{{ucfirst(strtolower($type))}}</option>
                                        @else
                                            <option selected="selected" value="{{$type}}">{{ucfirst(strtolower($type))}}</option>
                                        @endif
                                    @endforeach 
                                ...
                                <select name="location" class="form-control">
                                    @foreach($locations as $location)
                                        @if($widget->location == $location)
                                            <option selected="selected" value="{{$location}}">{{ucfirst(strtolower($location))}}</option>
                                        @else
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <textarea class="form-control"  name="content">{{$widget->content}}</textarea>
