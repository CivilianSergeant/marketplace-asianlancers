    ...
    <div class="pi-section pi-padding-bottom-30">
        ...
        <div class="pi-tabs-vertical pi-responsive-sm">
            ...
            <div class="pi-tabs-content pi-tabs-content-transparent">
                ...
                <!-- Tab content -->
                <div ng-app="qbuilderApp" ng-controller="qbuilderController">
                    <div class="pi-row">
                        <div class="pi-col-xs-12">
                            ...
                            <!-- Forms -->
                            <form id="questionFrm" ng-submit="addQuestion()" name="questionFrm" method="post">
                                ...
                                <div class="form-group qbuilder-selection">
                                    <label for="question_level" class="col-lg-3">Question Level  @{{lvl}}:</label>
                                    <div class="col-lg-3">
                                        ...
                                        <table class="pi-table pi-table-complex pi-table-hovered pi-round pi-table-shadow pi-table-all-borders">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="answer in form.answers">
                                                    ...
                                                    <td>
                                                        <input ng-if="(form.question_type != 'Textbox' && form.question_type == 'Checkbox')" ng-model="answer.correct" value="1"  type="checkbox" name="correct_answer[]"/>
                                                        <input ng-if="(form.question_type == 'Radio')" ng-model="answer.correct" value="1" type="radio" name="correct_answer[]"/>
                                                    </td>
                                                </tr>
