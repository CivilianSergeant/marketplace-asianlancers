    ...
    <h3 class="h4 pi-margin-bottom-5">
        ...
        <?php if($freelancer->available==1){ ?>
            ...
            <span class="select-box">
                Select&nbsp;
                <input ng-click="selectFreelancer()" id="select_freelancer<?php echo $start_index; ?>" style="margin: 7px 0 0" class="pull-right select-freelancer" type="radio" value="<?php echo $start_index++; ?>" />
            </span>
        <?php }else{ ?>
            <i class="avai" style="float: left;">
