...
<div class="pi-section pi-padding-bottom-30" ng-app="freelancerApp" ng-controller="freelancerAppController" ng-cloak>
...
<div ng-show="skills.length" class="pi-row">
    <div class="pi-col-sm-12">
        <ul class="pi-bullets-square pi-bullets-contur pi-bullets">
            ...
            <!--<li class="pi-col-sm-6"><span class="pi-bullet-icon"><i class="icon-flash"></i></span>HTML5 / CSS3</li>
            <li class="pi-col-sm-6"><span class="pi-bullet-icon"><i class="icon-flash"></i></span>Adobe Photoshop CS5, CS6 </li>
            <li class="pi-col-sm-6"><span class="pi-bullet-icon"><i class="icon-flash"></i></span>Adobe Illustrator CS5, CS6 </li>
            <li class="pi-col-sm-6"><span class="pi-bullet-icon"><i class="icon-flash"></i></span>Adobe Dreamweaver CS5, CS6 </li>
            <li class="pi-col-sm-6"><span class="pi-bullet-icon"><i class="icon-flash"></i></span>Responsive Website </li>
            <li class="pi-col-sm-6"><span class="pi-bullet-icon"><i class="icon-flash"></i></span>Bootstrap </li>
            <li class="pi-col-sm-6"><span class="pi-bullet-icon"><i class="icon-flash"></i></span>Parallax Website </li>-->
        </ul>
    </div>
        ...
        @else
            ...
            ?>
                <div class="pi-counter pi-counter-round pi-counter-line" data-counter-type="line" data-count-from="0" data-count-to="1" data-easing="easeInCirc" data-duration="2000" data-frames-per-second="10">
                    ...
                    <p class="pi-counter-label"><?php echo $get_tag['category_name']; ?>  Test not taken yet</p>
