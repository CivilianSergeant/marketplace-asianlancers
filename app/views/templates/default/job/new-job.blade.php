...
<script type="text/javascript" src="{{$theme}}js/custom/job/newjobcontroller.js"></script>
                        ...
                        <div class="pi-col-xs-12">
							...
							<form id="jobPostFrm" ng-submit="addJobPost()" name="jobPostFrm" method="post" >
                                <div class="form-group job-category-selection">
                                    ...
                                    <div class="col-lg-4">
                                        <select id="job_category_id" name="form.job_category_id" ng-model="form.job_category_id" class="form-control">
                                ...
                                <div class="pi-col-xs-12 pi-no-padding">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <!-- <input id="skill_tags_id" type="hidden" placeholder="Skill Required" style="width: 100%;" ui-select2="multiSkillSelection" ng-model="tmp_skill_tag"/> -->
                                            <ui-select multiple ng-model="tmp.tmp_skill_tag" theme="select2" ng-disabled="disabled" style="width: 300px;">
                                            <ui-select-match placeholder="Select skils...">@{{$item.category_name}}</ui-select-match>
                                ...
                                <div class="pi-col-xs-12 pi-no-padding ">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <!-- <input id="freelancer_price" type="hidden" placeholder="Hourly Price Required" style="width: 100%;" ui-select2="multiPriceSelection" ng-model="tmp_freelancer_price"/> -->
                                            <ui-select multiple ng-model="tmp.tmp_freelancer_price" theme="select2" ng-disabled="disabled" style="width: 300px;">
                                            <ui-select-match placeholder="Select skils...">@{{$item.title}}</ui-select-match>
                                                <ui-select-choices repeat="job_price in job_prices | filter:$select.search">
                                                 @{{job_price.title}}
                                            </ui-select-choices>
                                        </ui-select>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label for="freelancers" class="col-lg-3 pi-margin-top-15">Selected Freelancers: </label>
                                    <div class="col-lg-9 pi-margin-top-15">
                                        <ul class="oInlineListExtNew col-lg-7 ">
                                            <li ng-repeat="sf_lancer in selected_freelancers">
<!--                                                <div ng-if="haveFreelancer(sf_lancer.code)">-->
...
<!--                                                </div>-->
                                    ...
                                    <?php /* <div ng-show="addFreelancerFlag">
                                        {{Theme::make('partial.new-job-freelancer-search-list',array('page'=>$page))}}
                                    </div> */ ?>
                                    <br/><br/>
                                    <div id="ajaxContent">
                                    </div>
...
<!--                                    <div ng-show="loadingFlag" class="img-responsive" style="margin: 0 auto; text-align: center;">-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="pi-input-with-icon">
                                            ...
                                            <textarea rows="8" placeholder="Description" id="description" name="description" ng-model="form.description" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <p class="pi-col-xs-12" ng-show="saveButtonFlag">
                                    <button type="submit"
                                            class="btn pi-btn-green pi-btn-same pi-uppercase pi-weight-700 pi-letter-spacing pull-right">
