                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                               ...
                               <!-- <tr ng-repeat="x in userList | orderBy: x.first_name">-->
                                <tr ng-repeat="x in content| orderBy: x.first_name | filter:first_name ">
                                    ...
                                    <td>
                                       <!-- <a href="#" ng-click="open()" ><i class="icon-pencil"></i></a>-->
                                        <a href="#" ng-click="DisplayProfile(x)" ><i class="icon-eye"></i></a>
