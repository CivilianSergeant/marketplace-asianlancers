    ...
    <div class="pi-section pi-padding-bottom-30">
        ...
        <div class="pi-tabs-vertical pi-responsive-sm">
            ...
            <div class="pi-tabs-content pi-tabs-content-transparent">
                ...
                <!-- Tab content -->
                <div class="col-lg-12">
                    <form class="form-horizontal" action="{{url('page/update-page')}}" method="POST">
                        <div class="form-group">
                            <label class="col-lg-12">Title</label><br/>
                            <div class="col-lg-12">
                                <input type="text" maxlength="60" name="title" value="{{$page->title}}" class="form-control"/>
                                <span><small>Maximum Character (60)</small></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-12">Description</label><br/>
                            <textarea id="pageEditor" name="description">{{$page->description}}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <select name="page_type" class="form-control">
                                    @foreach($page_types as $page_type)
                                        ...
                                        <option selected="selected" value="{{$page_type}}">{{ucfirst(strtolower($page_type))}} Site</option>
                                        @else
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <textarea class="form-control" maxlength="100" name="excerpt">{{$page->excerpt}}</textarea>
                                <span><small>Maximum Character (100)</small></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-lg-12">
                                <input type="hidden" name="id" value="{{Helpers::EncodeDecode($page->id)}}"/>
