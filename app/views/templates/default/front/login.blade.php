        ...
        <div class="pi-row">
            ...
            <div class="pi-col-md-4 pi-col-md-offset-4 pi-col-sm-6 pi-col-sm-offset-3 pi-col-xs-8 pi-col-xs-offset-2">
                    ...
                    <div class="form-group">
                        <div class="pi-input-with-icon">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail" name="email"
                                   placeholder="{{Translate::get('E-mail',$lang)}}">
                        </div>
                    </div>
                    <!-- End email form -->
                    ...
                    <div class="form-group">
                        <div class="pi-input-with-icon">
                            ...
                            <input type="password" class="form-control" id="exampleInputPassword" name="password"
                                   placeholder="{{Translate::get('Password',$lang)}}">
                        </div>
                    </div>
                    <!-- End password form -->
                ...
                <p class="pi-text-center">
                    {{Translate::get("Don't have Account?",$lang)}} <a href="{{url('home/sign-up-client')}}" class="pi-weight-600">{{Translate::get("Sign Up",$lang)}}</a>
                </p>
