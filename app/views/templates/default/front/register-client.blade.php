                ...
                <div class="pi-box pi-round pi-shadow-15">
                    ...
                    <div class="checkbox pi-margin-bottom-20">
                        <label class="pi-small-text">
                            <input type="checkbox" id="agreement" name="agreement" value="Yes" data-ng-init="checked = 1" data-ng-model="checked" data-ng-checked="checked" >{{Translate::get("I agree to the",$lang)}} <a href="#">{{Translate::get("Terms of Use",$lang)}}</a>
                        </label>
                    </div>
                    <!-- End checkbox -->
