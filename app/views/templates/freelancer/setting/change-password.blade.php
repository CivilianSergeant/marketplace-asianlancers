            ...
            <div class="pi-tabs-content pi-tabs-content-transparent">
               ...
               <!-- <div  ng-app="userApp" data-ng-controller="AdminController">-->
                   ...
                   <!-- <div data-ng-app="settingApp" data-ng-controller="settingController">-->
                      ...
                      <div ng-cloak class="pi-row col-lg-7 pull-right">
                          <div ng-model="errorMsg" ng-show="errorMsg !=''" style="padding:9px;" >
                              <button data-dismiss="alert" class="pi-close" type="button">
                                  <i class="icon-cancel"></i>
                              </button>
                    
                                <a style="color:#F00;" id="top">@{{errorMsg}}</a>

                          </div>
                          <div  ng-model="successMsg"  ng-show="successMsg !=''" style="padding:9px;">
                              <button data-dismiss="alert" class="pi-close" type="button">
                                  <i class="icon-cancel"></i>
                              </button>
                              <a style="color:#10a95b;" id="top">@{{successMsg}}</a>
