                    ...
                    <form id="updateContactFrm" ng-submit="updateContact()">
                        <table class="pi-table pi-table-complex pi-table-hovered pi-round pi-table-shadow pi-table-all-borders">
                            ...
                            <tr>
                                ...
                                <th>
                                    <div class="col-lg-10">
                                        <textarea name="address" required ng-model="form.address" class="form-control"></textarea>
                                    </div>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th>
                                    <div class="col-lg-10">
                                        <input name="country" required ng-model="form.country" class="form-control" typeahead="c.name for c in country | filter:$viewValue | limitTo:5" />
                                    </div>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th>
                                    <div class="col-lg-10">
                                        <input required name="area" ng-model="form.city" class="form-control" />
                                    </div>
                                </th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <th>
                                    <div class="col-lg-10">
                                        <input name="zip" required ng-model="form.zip" class="form-control" />
                                    </div>
                                </th>
                            </tr>
                            <tr>
