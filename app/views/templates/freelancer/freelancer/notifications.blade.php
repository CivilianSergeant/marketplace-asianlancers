            ...
            <div class="pi-tabs-content pi-tabs-content-transparent">
                ...
                <div ng-app="">
                    <div ng-cloak class="pi-row col-lg-12 pi-no-padding-right pi-no-margin-right">
                        <h3 class="h4 pi-weight-700 pi-uppercase pi-letter-spacing pi-margin-bottom-20 pi-has-bg"> Notification </h3>
                        <table class="table table-stripped table-responsive">
                            ...
                            <tfoot>
                            <tr>
                                <td colspan="5" style="padding:0;">{{$notificationList->links()}}</td>
                            </tr>
                            </tfoot>
                        </table>
                    </div>
