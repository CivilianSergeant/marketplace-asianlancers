                    ...
                    <div class="pi-row col-lg-12">
                        <div class="pi-tab-pane" id="jobhistory">
                            ...
                            <h3 class="h4 pi-weight-700 pi-uppercase pi-letter-spacing pi-margin-bottom-20 pi-has-bg">
                                {{Translate::get("Job invitation",$lang)}}
                            </h3>
                            ...
                            <div class="pi-responsive-table-sm">
                                <table class="pi-table pi-table-complex pi-table-hovered pi-round pi-table-shadow pi-table-all-borders">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$invitation->title}} <br/><i class="pr-date"><a target="_blank" href="{{url('view/client/'.$clientId)}}"{{$client->getName()}}>{{$client->getName()}}</a></i></td>

                                        <td>
                                            {{$invitation->job_offer_price}}
                                        </td>
                                        <td>{{Helpers::dateTimeFormat("j F, Y",$invitation->created_at)}}</td>
                                        <td align="center">
