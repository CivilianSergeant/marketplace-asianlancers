        ...
        <div class="pi-row">
            ...
            <div class="pi-col-md-4 pi-col-md-offset-4 pi-col-sm-6 pi-col-sm-offset-3 pi-col-xs-8 pi-col-xs-offset-2">
                ...
                <div class="pi-box pi-round pi-shadow-15">
                    ...
                    <div class="form-group">
                        <div class="pi-input-with-icon">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="{{Translate::get('First name',$lang)}}"
                    ...
                    <div class="form-group">
                        <div class="pi-input-with-icon">
                            <div class="pi-input-icon"><i class="icon-user"></i></div>
                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="{{Translate::get('Last name',$lang)}}"
                                   data-bv-notempty="true"
                    ...
                    <div class="form-group">
                        <div class="pi-input-with-icon">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="{{Translate::get('E-mail',$lang)}}"
                                   data-bv-notempty="true"
                    ...
                    <div class="form-group">
                        <div class="pi-input-with-icon">
                            ...
                            <input type="password" class="form-control" id="password" name="password" placeholder="{{Translate::get('Password',$lang)}}"
                    ...
                    <div class="form-group">
                        <div class="pi-input-with-icon">
                            <div class="pi-input-icon"><i class="icon-lock"></i></div>
                            <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="{{Translate::get("Confirm Password",$lang)}}"
                                   data-bv-notempty="true"
                    ...
                    <div class="checkbox pi-margin-bottom-20">
                        <label class="pi-small-text">
                            <input type="checkbox" id="agency" name="agency" value="" data-ng-init="CompanyHide = 0" data-ng-model="CompanyHide" data-ng-checked="CompanyHide" >{{Translate::get("Signup as an Agency",$lang)}}
                        </label>
                    </div>
                    ...
                    <div class="checkbox pi-margin-bottom-20">
                        <label class="pi-small-text">
                            <input type="checkbox" id="agreement" name="agreement" checked="checked" data-ng-init="checked = 1" data-ng-model="checked" data-ng-checked="checked">{{Translate::get("I agree to the",$lang)}} <a href="#">{{Translate::get("Terms of Use",$lang)}}</a>
                        </label>
                    </div>
                    <!-- End checkbox -->
                    ...
                    <p>
                        <button type="submit" data-ng-disabled="!checked" class="btn pi-btn-wide pi-weight-600 pi-btn-blue">
                            {{Translate::get("Create An Account",$lang)}}
                        </button>
                    </p>
                    <!-- End submit button -->
                ...
                <p class="pi-text-center">
                    {{Translate::get("Have an Account?",$lang)}} <a href="{{url('home/login')}}" class="pi-weight-600">{{Translate::get("Sign In",$lang)}}</a>
                </p>
