...
<body>
  <div style="width:100%; min-height:50px; background:#fff; padding:20px 0 10px 0; border-bottom: medium solid #dcdcdc;">
    ...
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      <a href="http://asianlancers.com" style="text-decoration:none;">
        <img style="width:145px;" src="http://client.asianlancers.com/public/themes/default/img/logo-base.png" alt="logo" />
  ...
  <div style="background:#f2f4fa; min-height:150px; padding:30px 0;" >
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      ...
      <p style="padding-bottom:10px; text-align:justify;">Welcome to the asianlancers.com. You have entered in the largest Asian IT freelancer’s market place. The market is only focus on IT projects and best IT professionals. </p>
      <p style="padding-bottom:10px; text-align:justify;">To activate your account, Please click following link</p>
      <a href="{{url('home/activate')}}/{{$id}}/{{$activation_code}}/{{$type}}/{{$company}}" style="-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px; text-align:center; line-height:27px; min-width:90px; color:#FFF; font-size:11px; text-transform:uppercase; text-decoration:none; background:#8093a1; clear:both; display:inline-block; padding:1px 6px !important;">Verify your email</a>
    </div>
  </div>

  <div style="background:#353946; min-height:50px; padding:20px 0 10px 0;">
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      <a href="http://asianlancers.com"><img src="http://client.asianlancers.com/public/themes/default/img/logo2.png" alt="logo" /></a>
