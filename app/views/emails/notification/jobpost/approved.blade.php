...
<body>
  ...
  <div style="background:#f2f4fa; min-height:150px; padding:30px 0;" >
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      ...
      <p style="padding-bottom:10px; text-align:justify;"><strong>Congratulation!</strong> You have properly followed our job posting criteria. The job is now on board for available freelancers.</p>
