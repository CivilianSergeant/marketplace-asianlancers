...
<body>
  ...
  <div style="background:#f2f4fa; min-height:150px; padding:30px 0;" >
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      ...
      <p style="padding-bottom:10px; text-align:justify;">You have been successfully created a new job “{{$job_title}}” in {{$job_category}}. The job will be placed on board for available freelancers. Our support team will check the job authentication and reply will within 2 hours. </p>
