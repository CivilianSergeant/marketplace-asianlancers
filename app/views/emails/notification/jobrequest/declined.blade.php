...
<title>Job Application Decliend By Client</title>
...
<body>
  ...
  <div style="background:#f2f4fa; min-height:150px; padding:30px 0;" >
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      ...
      <p style="padding-bottom:10px; text-align:justify;">Sorry! Client {{$client}} has been declined your job application of job "{{$job_title}}"</p>
    </div>
  </div>
