...
<title>Freelancer Applied to Job</title>
...
<body>
  ...
  <div style="background:#f2f4fa; min-height:150px; padding:30px 0;" >
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      ...
      <p style="padding-bottom:10px; text-align:justify;">“{{$freelancer_name}}” has been applied to  job "{{$job_title}}", Please forward the request to the client by verifing this job application</p>
      <p style="padding-bottom:10px; text-align:justify;">Please visit the following link to see the job application</p>
