...
<title>Job Phase Assigned</title>
...
<body>
  ...
  <div style="background:#f2f4fa; min-height:150px; padding:30px 0;" >
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      ...
      <p style="padding-bottom:10px; text-align:justify;">Job phase “{{$job_phase_title}}” was assigned to you for job offer "{{$job_offer_title}}"</p>
