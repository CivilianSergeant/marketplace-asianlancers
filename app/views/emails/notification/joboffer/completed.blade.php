...
<body>
  ...
  <div style="background:#f2f4fa; min-height:150px; padding:30px 0;" >
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      ...
      <p style="padding-bottom:10px; text-align:justify;">{{$client}} has been closed job offer “{{$job_offer_title}}” for job "{{$job_title}}"</p>
      <p style="padding-bottom:10px; text-align:justify;">Please visit the following link to see the job details</p>
      <a href="{{$link}}" style="-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px; text-align:center; line-height:27px; min-width:90px; color:#FFF; font-size:11px; text-transform:uppercase; text-decoration:none; background:#8093a1; clear:both; display:inline-block; padding:1px 6px !important;">
  ...
  <div style="background:#353946; min-height:50px; padding:20px 0 10px 0;">
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      <a href="http://asianlancers.com"><img src="http://client.asianlancers.com/public/themes/default/img/logo2.png" />
      </a>
