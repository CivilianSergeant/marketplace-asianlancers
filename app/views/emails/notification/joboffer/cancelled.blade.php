...
<title>Job Offer Canceled</title>
...
<body>
  ...
  <div style="background:#f2f4fa; min-height:150px; padding:30px 0;" >
    <div style="width:600px; min-height:50px; clear:both; margin:0 auto;">
      ...
      <p style="padding-bottom:10px; text-align:justify;">Sorry! Your job offer “{{$job_offer_title}}” was cancelled, you should maintain rules during creation of job offer</p>
